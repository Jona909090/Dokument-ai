...
export interface PaperDesignConfig{version:1;presetId:string;color:PaperColorConfig;pattern:BackgroundPatternConfig;lines:DecorativeLineConfig[];shapes:DecorativeShapeConfig[];safeZone:boolean;pageVariants:PageVariantConfig;printSafe:PrintSafeConfig;}
