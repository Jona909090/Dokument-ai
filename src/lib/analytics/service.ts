...
const categoryByType: Record<DocumentType, DocumentCategory> = {
  cv: "hr", invoice: "finance", proforma: "finance", offer: "construction", contract: "legal", request: "administration", termination: "hr", "purchase-order": "construction", minutes: "administration", certificate: "administration", "business-letter": "administration",
};
