...
const fieldsByType: Record<Exclude<DocumentType, "invoice" | "proforma" | "offer" | "daily-report">, FieldDefinition[]> = {
  cv: [
...
type CategoryFormProps = {
  type: Exclude<DocumentType, "invoice" | "proforma" | "offer" | "purchase-order" | "daily-report">;
