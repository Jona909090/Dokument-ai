...
import { BarChart3, Bell, Building2, CircleHelp, ContactRound, FilePlus2, Files, FileText, Info, LayoutDashboard, Menu, Search, Settings, Star, UserRound, X } from "lucide-react";
...
const links = [
  ...
  { href: "/documents", label: "Moji dokumenti", icon: Files },
...
export function DashboardNav({ email }: { email: string }) {
  ...
  const sidebar = <div className="flex h-full flex-col bg-card p-4 text-card-foreground">
    ...
    <Link href="/wizard" className={cn(buttonVariants(), "mt-5 justify-start")}><FilePlus2 className="size-4" /> Novi dokument</Link>
